...
class Evaluator:
    ...
    def evaluate(self, rank=0):
        ...
        model = load_adapter(model, save_path_and_name=self.work_dir+'/adapter.pt', log=True)
        model.eval()
        ...
        with open(args.work_dir+f'/eval_info_list_{rank}.json', 'w', encoding='utf-8') as f:
