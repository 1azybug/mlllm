...
# only don't load the adapter beacause we finetune from llama2(line 147)
...
CUDA_VISIBLE_DEVICES=0,1 python ./vanilla_trainer.py --work_dir debug_CompressLLM_wo-cmp --port 12314
"""
